...
namespace GP.Tools.ReaderMe.Model
{
    ...
    {
        private static Configurations m_ConfigInstance = null;
        ...
        {
            if (null == m_ConfigInstance)
            {
                string filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ReaderMe.xml");
                m_ConfigInstance = new Configurations(filePath);
            }
